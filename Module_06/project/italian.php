...
<body>
  ...
  <div class="container" id="main">
    ...
    <h2 class="mobnav">Italian Menu </h2>
    <p> View our Italian menu offerings.</p>
      ...
      <div class="col-sm-4 menumargin">
        <div class="row typeitem"><h4>Italian Classics</h4></div><br>
        <?php
          include 'config.php';
          include 'opendb.php';
          $sql= "SELECT itemname, itemdesc, cost FROM menu WHERE itemtype = 'itclass' LIMIT 5";
      ...
      <div class="col-sm-4 menumargin">
        <div class="row typeitem"><h4>Pasta</h4></div><br>
        <?php
          include 'config.php';
          include 'opendb.php';
          $sql= "SELECT itemname, itemdesc, cost FROM menu WHERE itemtype = 'pasta' LIMIT 5";
          $result= mysqli_query($conn, $sql);
      ...
      <div class="col-sm-4 menumargin">
        <div class="row typeitem"><h4>Subs</h4></div><br>
        <?php
          include 'config.php';
          include 'opendb.php';
          $sql= "SELECT itemname, itemdesc, cost FROM menu WHERE itemtype = 'subs' LIMIT 5";
          $result= mysqli_query($conn, $sql);
